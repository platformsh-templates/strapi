...
var BrowserTracing = /** @class */ (function () {
    ...
    BrowserTracing.prototype._createRouteTransaction = function (context) {
        ...
        var ctx = beforeNavigate(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, context), getHeaderContext()), { trimEnd: true }));
        if (ctx === undefined) {
            utils_1.logger.log("[Tracing] Did not create " + context.op + " idleTransaction due to beforeNavigate");
            return undefined;
        }
        var hub = this._getCurrentHub();
        utils_1.logger.log("[Tracing] starting " + ctx.op + " idleTransaction on scope");
        var idleTransaction = hubextensions_1.startIdleTransaction(hub, ctx, idleTimeout, true);
